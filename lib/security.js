...
// WeChat Pay requires out_trade_no to be 6-32 characters using a restricted
// ASCII alphabet. 13 random bytes provide 104 bits of entropy at exactly 32
// characters including the ORDER_ prefix.
export function paymentOrderId() {
  return `ORDER_${crypto.randomBytes(13).toString("hex")}`;
}
